...
#  2.00     2025-05-28  JS     -Add func processing elements ConditionsForContinue,        *
                                ReplaceConst                                               *
#  3.00     2025-07-08  JS     -Add func processing zip files                              *
#*******************************************************************************************
# Import
#*******************************************************************************************
import os
...
def colect_copy_data(config_file_path):
    ...
    if (zip_path_elem is None):
        ...
        zip_path = zip_path_elem.text
    if (os.path.exists(zip_path)):
        copy_data["zip_path"] = zip_path
    else:
        print("PathToZip does not exist.")
        cprint("Script stoped", 'red')
        exit()
